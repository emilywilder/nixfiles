      ...
      system.defaults.NSGlobalDomain."com.apple.desktopservices DSDontWriteNetworkStores" = true;
      system.defaults.NSGlobalDomain."com.apple.desktopservices DSDontWriteUSBStores" = true;

      # Don't autofill in Safari.
      system.defaults.NSGlobalDomain."com.apple.Safari AutoFillFromAddressBook" = false;
      system.defaults.NSGlobalDomain."com.apple.Safari AutoFillPasswords" = false;
      system.defaults.NSGlobalDomain."com.apple.Safari AutoFillCreditCardData" = false;
      system.defaults.NSGlobalDomain."com.apple.Safari AutoFillMiscellaneousForms" = false;
      ...
      system.defaults.NSGlobalDomain."com.apple.terminal SecureKeyboardEntry" = true;
